  ...
  export const ExperienceCard = ({ experience, onClick }: ExperienceCardProps) => (
    ...
    >
      <div className="relative h-72 overflow-hidden rounded-xl border border-[#588061]/20">
        <Image
        ...
        <div className="absolute bottom-0 left-0 right-0 p-2">
          <span className="mb-3 inline-block rounded-full bg-[#588061] px-4 py-1 text-sm text-white">
            {experience.date}
          </span>
