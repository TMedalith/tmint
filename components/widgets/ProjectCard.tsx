...
const ProjectCard = ({ project }: ProjectCardProps) => {
  ...
  return (
    <article className="max-w-6xl mx-auto p-6 group">
      <div className="bg-gradient-to-br from-gray-900/90 to-transparent backdrop-blur rounded-2xl border border-[#588061]/20 overflow-hidden transition-transform duration-300 hover:scale-[0.98]">
        {}
